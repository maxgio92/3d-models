...
- the front ring follows a steeper Z-based curve from near-flat through the center band to `10 mm`, with an extra `8 mm` only in the last `10 mm` of the bottom limb;
